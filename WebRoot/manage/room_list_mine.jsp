...
function showCheck(id){
	window.location = "/Rental/room!toCheckStreamView.action?room.roomId="+id;
}
</script>
</head>
<body>
<div class="panel panel-default">
  ...
  <table>
  	<tr>
  		<td class="myLable">  标题：</td><td><input type="text" id="areaName" class="form-control"> &nbsp;</td>
  		<td class="myLable"> 简介：</td><td><input type="text" id="areaDesc" class="form-control"> &nbsp;</td>
  		<td class="myLable">  审核状态:</td><td><select id="checkState" class="form-control"><option>--请选择--</option><option>未审核</option><option>审核中</option><option>通过</option><option>拒绝</option> </select></td>
  	</tr>
  	<tr>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">
    	房源列表
    	<button type="button" class="btn btn-success btn-sm" style="float: right; margin-right:10px; margin-top: -5px;" onclick="addRoom()">
