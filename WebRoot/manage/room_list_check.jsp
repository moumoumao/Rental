		...
		success:function(data){
			...
			if(data.aaData==''){
				...
				$.each(data.aaData, function(i,obj){      
					...
					"<td>"+isNullStr(obj.create.userName)+" </td>"+
...
function showRoom(id){
	window.parent.location = "/Rental/room!findByIdForCheck.action?room.roomId="+id;
