...
var config = {
    ...
    right: -232,
    api: {
        friend: '/CQRental/user!findAllUser.action', //好友列表接口
        group: '../../layui/layim/group.json', //群组列表接口 
        chatlog: '../../layui/layim/chatlog.json', //聊天记录接口
        groups: '../../layui/layim/groups.json', //群组成员接口
        sendurl: '' //发送消息接口
    },
    user: { //当前用户信息
        name: '游客',
