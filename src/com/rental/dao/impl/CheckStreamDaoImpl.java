...
public class CheckStreamDaoImpl extends HibernateDaoSupport implements
		CheckStreamDao {

	public TblCheckStream addStream(TblCheckStream stream) {
		super.getHibernateTemplate().save(stream);
		return stream;
	}
	...
	public PageBean findByMixAndPage(Map<String, Object> map, int pageSize,
			int pageNo) {
		// 查询数据sql
		StringBuffer sql = new StringBuffer("from TblCheckStream o where 1=1");
